...
func (in *ActorIdentityTokenDataSource) DeepCopyInto(out *ActorIdentityTokenDataSource) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ActorIdentityTokenDataSource.
func (in *ActorIdentityTokenDataSource) DeepCopy() *ActorIdentityTokenDataSource {
	if in == nil {
		return nil
	}
	out := new(ActorIdentityTokenDataSource)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SystemInfoDataSource) DeepCopyInto(out *SystemInfoDataSource) {
	*out = *in
	...
	if in.ActorIdentityToken != nil {
		in, out := &in.ActorIdentityToken, &out.ActorIdentityToken
		*out = new(ActorIdentityTokenDataSource)
		(*in).DeepCopyInto(*out)
	}
}
