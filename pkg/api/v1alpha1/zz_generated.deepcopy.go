...
func (in *ActorIdentityDataSource) DeepCopyInto(out *ActorIdentityDataSource) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ActorIdentityDataSource.
func (in *ActorIdentityDataSource) DeepCopy() *ActorIdentityDataSource {
	if in == nil {
		return nil
	}
	out := new(ActorIdentityDataSource)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SystemInfoDataSource) DeepCopyInto(out *SystemInfoDataSource) {
	*out = *in
	if in.ActorIdentity != nil {
		in, out := &in.ActorIdentity, &out.ActorIdentity
		*out = new(ActorIdentityDataSource)
		**out = **in
	}
}
