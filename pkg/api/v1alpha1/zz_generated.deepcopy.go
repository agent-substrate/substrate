...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ActorVolume) DeepCopyInto(out *ActorVolume) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ActorVolume.
func (in *ActorVolume) DeepCopy() *ActorVolume {
	if in == nil {
		return nil
	}
	out := new(ActorVolume)
