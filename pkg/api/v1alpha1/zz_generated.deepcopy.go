...
func (in *ActorIDSource) DeepCopyInto(out *ActorIDSource) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ActorIDSource.
func (in *ActorIDSource) DeepCopy() *ActorIDSource {
	if in == nil {
		return nil
	}
	out := new(ActorIDSource)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ActorTemplateSpec) DeepCopyInto(out *ActorTemplateSpec) {
	*out = *in
	...
	if in.SystemInfoVolumes != nil {
		in, out := &in.SystemInfoVolumes, &out.SystemInfoVolumes
		*out = make([]SystemInfoVolume, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CertSource) DeepCopyInto(out *CertSource) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CertSource.
func (in *CertSource) DeepCopy() *CertSource {
	if in == nil {
		return nil
	}
	out := new(CertSource)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SystemInfoVolume) DeepCopyInto(out *SystemInfoVolume) {
	*out = *in
	if in.ActorID != nil {
		in, out := &in.ActorID, &out.ActorID
		*out = make([]ActorIDSource, len(*in))
		copy(*out, *in)
	}
	if in.JWT != nil {
		in, out := &in.JWT, &out.JWT
		*out = make([]JWTSource, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.Cert != nil {
		...
		*out = make([]CertSource, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SystemInfoVolume.
func (in *SystemInfoVolume) DeepCopy() *SystemInfoVolume {
	if in == nil {
		return nil
	}
	out := new(SystemInfoVolume)
	in.DeepCopyInto(out)
	return out
}
