...
type ContainerReadyz struct {
	...
	// timeout_seconds bounds how long to probe before failing the
	...
	// tcp_socket specifies the TCP connection to attempt.
	//
	// +k8s:optional
	// +k8s:unionMember
...
func (x *ContainerReadyz) GetTcpSocket() *TCPSocketAction {
	if x != nil {
		return x.TcpSocket
	}
	return nil
...
// TCPSocketAction connects to a port on the container's interior IP.
// A successful connection signals readiness; no application data is exchanged.
type TCPSocketAction struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// port is the TCP port to connect to (1..65535).
	//
	// +k8s:required
	// +k8s:minimum=1
	// +k8s:maximum=65535
...
const file_ateapi_proto_rawDesc = "" +
	...
	"\n" +
	"tcp_socket\x18\x03 \x01(\v2\x17.ateapi.TCPSocketActionR\ttcpSocket\"7\n" +
	"\rHTTPGetAction\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\x12\x12\n" +
	"\x04port\x18\x02 \x01(\x05R\x04port\"%\n" +
	"\x0fTCPSocketAction\x12\x12\n" +
	"\x04port\x18\x01 \x01(\x05R\x04port\"\xa9\x02\n" +
	"\x06Volume\x12\x12\n" +
...
var file_ateapi_proto_goTypes = []any{
	...
	(*TCPSocketAction)(nil),                    // 41: ateapi.TCPSocketAction
...
var file_ateapi_proto_depIdxs = []int32{
	...
	42,  // 34: ateapi.ActorTemplate.volumes:type_name -> ateapi.Volume
	...
	51,  // 50: ateapi.Container.volume_mounts:type_name -> ateapi.VolumeMount
	...
	41,  // 55: ateapi.ContainerReadyz.tcp_socket:type_name -> ateapi.TCPSocketAction
