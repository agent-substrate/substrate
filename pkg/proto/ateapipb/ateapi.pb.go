...
var file_ateapi_proto_goTypes = []any{
	...
	(*LocalSnapshotInfo)(nil),             // 8: ateapi.LocalSnapshotInfo
	...
	(*ActorStatus)(nil),                   // 13: ateapi.ActorStatus
	(*ActorSourceSnapshotStatus)(nil),     // 14: ateapi.ActorSourceSnapshotStatus
	(*WorkerAssignment)(nil),              // 15: ateapi.WorkerAssignment
	(*ActorSnapshot)(nil),                 // 16: ateapi.ActorSnapshot
	(*ActorSnapshotStatus)(nil),           // 17: ateapi.ActorSnapshotStatus
	...
	(*GoldenSnapshotStatus)(nil),          // 24: ateapi.GoldenSnapshotStatus
...
var file_ateapi_proto_depIdxs = []int32{
	...
	10,  // 6: ateapi.Actor.metadata:type_name -> ateapi.ResourceMetadata
	20,  // 7: ateapi.Actor.actor_template:type_name -> ateapi.ObjectRef
	9,   // 8: ateapi.Actor.worker_selector:type_name -> ateapi.Selector
	20,  // 9: ateapi.Actor.source_snapshot_tag:type_name -> ateapi.ObjectRef
	13,  // 10: ateapi.Actor.status:type_name -> ateapi.ActorStatus
	2,   // 11: ateapi.ActorStatus.state:type_name -> ateapi.ActorState
	15,  // 12: ateapi.ActorStatus.worker_assignment:type_name -> ateapi.WorkerAssignment
	20,  // 13: ateapi.ActorStatus.latest_snapshot:type_name -> ateapi.ObjectRef
	8,   // 14: ateapi.ActorStatus.local_snapshot_info:type_name -> ateapi.LocalSnapshotInfo
	11,  // 15: ateapi.ActorStatus.actor_volumes:type_name -> ateapi.ExternalVolume
	14,  // 16: ateapi.ActorStatus.source_snapshot:type_name -> ateapi.ActorSourceSnapshotStatus
	20,  // 17: ateapi.ActorSourceSnapshotStatus.snapshot:type_name -> ateapi.ObjectRef
	20,  // 18: ateapi.WorkerAssignment.worker:type_name -> ateapi.ObjectRef
	10,  // 19: ateapi.ActorSnapshot.metadata:type_name -> ateapi.ResourceMetadata
	17,  // 20: ateapi.ActorSnapshot.status:type_name -> ateapi.ActorSnapshotStatus
	20,  // 21: ateapi.ActorSnapshotStatus.source_actor:type_name -> ateapi.ObjectRef
	0,   // 22: ateapi.ActorSnapshotStatus.content_scope:type_name -> ateapi.SnapshotContentScope
	20,  // 23: ateapi.ActorSnapshotStatus.actor_template:type_name -> ateapi.ObjectRef
	10,  // 24: ateapi.ActorSnapshotTag.metadata:type_name -> ateapi.ResourceMetadata
	20,  // 25: ateapi.ActorSnapshotTag.snapshot:type_name -> ateapi.ObjectRef
	1,   // 26: ateapi.ActorSnapshotTag.scope:type_name -> ateapi.ActorSnapshotTagScope
	10,  // 27: ateapi.Atespace.metadata:type_name -> ateapi.ResourceMetadata
	10,  // 28: ateapi.ActorTemplate.metadata:type_name -> ateapi.ResourceMetadata
	9,   // 29: ateapi.ActorTemplate.worker_selector:type_name -> ateapi.Selector
	...
	23,  // 36: ateapi.Resources.limits:type_name -> ateapi.Limits
	20,  // 37: ateapi.GoldenSnapshotStatus.golden_snapshot:type_name -> ateapi.ObjectRef
	93,  // 38: ateapi.GoldenSnapshotStatus.take_golden_snapshot_at:type_name -> google.protobuf.Timestamp
	24,  // 39: ateapi.ActorTemplateStatus.golden_snapshot_status:type_name -> ateapi.GoldenSnapshotStatus
	37,  // 40: ateapi.ActorTemplateStatus.sandbox_assets:type_name -> ateapi.SandboxAssets
	...
	19,  // 55: ateapi.CreateAtespaceRequest.atespace:type_name -> ateapi.Atespace
	20,  // 56: ateapi.GetAtespaceRequest.atespace:type_name -> ateapi.ObjectRef
	19,  // 57: ateapi.ListAtespacesResponse.atespaces:type_name -> ateapi.Atespace
	20,  // 58: ateapi.DeleteAtespaceRequest.atespace:type_name -> ateapi.ObjectRef
	21,  // 59: ateapi.CreateActorTemplateRequest.actor_template:type_name -> ateapi.ActorTemplate
	20,  // 60: ateapi.GetActorTemplateRequest.actor_template:type_name -> ateapi.ObjectRef
	21,  // 61: ateapi.ListActorTemplatesResponse.actor_templates:type_name -> ateapi.ActorTemplate
	20,  // 62: ateapi.DeleteActorTemplateRequest.actor_template:type_name -> ateapi.ObjectRef
	20,  // 63: ateapi.GetActorRequest.actor:type_name -> ateapi.ObjectRef
	12,  // 64: ateapi.CreateActorRequest.actor:type_name -> ateapi.Actor
	12,  // 65: ateapi.UpdateActorRequest.actor:type_name -> ateapi.Actor
	20,  // 66: ateapi.SuspendActorRequest.actor:type_name -> ateapi.ObjectRef
	12,  // 67: ateapi.SuspendActorResponse.actor:type_name -> ateapi.Actor
	20,  // 68: ateapi.PauseActorRequest.actor:type_name -> ateapi.ObjectRef
	12,  // 69: ateapi.PauseActorResponse.actor:type_name -> ateapi.Actor
	20,  // 70: ateapi.ResumeActorRequest.actor:type_name -> ateapi.ObjectRef
	12,  // 71: ateapi.ResumeActorResponse.actor:type_name -> ateapi.Actor
	20,  // 72: ateapi.DeleteActorRequest.actor:type_name -> ateapi.ObjectRef
	20,  // 73: ateapi.GetActorSnapshotRequest.actor_snapshot:type_name -> ateapi.ObjectRef
	20,  // 74: ateapi.GetActorSnapshotTagRequest.actor_snapshot_tag:type_name -> ateapi.ObjectRef
	16,  // 75: ateapi.ListActorSnapshotsResponse.actor_snapshots:type_name -> ateapi.ActorSnapshot
	18,  // 76: ateapi.CreateActorSnapshotTagRequest.actor_snapshot_tag:type_name -> ateapi.ActorSnapshotTag
	18,  // 77: ateapi.UpdateActorSnapshotTagRequest.actor_snapshot_tag:type_name -> ateapi.ActorSnapshotTag
	20,  // 78: ateapi.DeleteActorSnapshotTagRequest.actor_snapshot_tag:type_name -> ateapi.ObjectRef
	77,  // 79: ateapi.ListWorkersResponse.workers:type_name -> ateapi.Worker
	20,  // 80: ateapi.GetWorkerRequest.worker:type_name -> ateapi.ObjectRef
	77,  // 81: ateapi.CreateWorkerRequest.worker:type_name -> ateapi.Worker
	77,  // 82: ateapi.UpdateWorkerRequest.worker:type_name -> ateapi.Worker
	20,  // 83: ateapi.DeleteWorkerRequest.worker:type_name -> ateapi.ObjectRef
	67,  // 84: ateapi.DeleteWorkerRequest.options:type_name -> ateapi.DeleteOptions
	20,  // 85: ateapi.DrainWorkerRequest.worker:type_name -> ateapi.ObjectRef
	12,  // 86: ateapi.ListActorsResponse.actors:type_name -> ateapi.Actor
	10,  // 87: ateapi.Worker.metadata:type_name -> ateapi.ResourceMetadata
	92,  // 88: ateapi.Worker.labels:type_name -> ateapi.Worker.LabelsEntry
	79,  // 89: ateapi.Worker.capacity:type_name -> ateapi.WorkerCapacity
	78,  // 90: ateapi.Worker.status:type_name -> ateapi.WorkerStatus
	5,   // 91: ateapi.WorkerStatus.state:type_name -> ateapi.WorkerState
	80,  // 92: ateapi.WorkerStatus.assignment:type_name -> ateapi.ActorAssignment
	81,  // 93: ateapi.ActorAssignment.actor_template:type_name -> ateapi.KubeNamespacedObjectRef
	20,  // 94: ateapi.ActorAssignment.actor:type_name -> ateapi.ObjectRef
	20,  // 95: ateapi.MintCertRequest.worker:type_name -> ateapi.ObjectRef
	6,   // 96: ateapi.MintCertRequest.purpose:type_name -> ateapi.ActorCertificatePurpose
	38,  // 97: ateapi.SandboxAssets.AssetsEntry.value:type_name -> ateapi.ArchAssets
	39,  // 98: ateapi.ArchAssets.FilesEntry.value:type_name -> ateapi.AssetFile
	50,  // 99: ateapi.Control.GetActor:input_type -> ateapi.GetActorRequest
	51,  // 100: ateapi.Control.CreateActor:input_type -> ateapi.CreateActorRequest
	52,  // 101: ateapi.Control.UpdateActor:input_type -> ateapi.UpdateActorRequest
	53,  // 102: ateapi.Control.SuspendActor:input_type -> ateapi.SuspendActorRequest
	55,  // 103: ateapi.Control.PauseActor:input_type -> ateapi.PauseActorRequest
	57,  // 104: ateapi.Control.ResumeActor:input_type -> ateapi.ResumeActorRequest
	59,  // 105: ateapi.Control.DeleteActor:input_type -> ateapi.DeleteActorRequest
	60,  // 106: ateapi.Control.GetActorSnapshot:input_type -> ateapi.GetActorSnapshotRequest
	61,  // 107: ateapi.Control.GetActorSnapshotTag:input_type -> ateapi.GetActorSnapshotTagRequest
	62,  // 108: ateapi.Control.ListActorSnapshots:input_type -> ateapi.ListActorSnapshotsRequest
	64,  // 109: ateapi.Control.CreateActorSnapshotTag:input_type -> ateapi.CreateActorSnapshotTagRequest
	65,  // 110: ateapi.Control.UpdateActorSnapshotTag:input_type -> ateapi.UpdateActorSnapshotTagRequest
	66,  // 111: ateapi.Control.DeleteActorSnapshotTag:input_type -> ateapi.DeleteActorSnapshotTagRequest
	68,  // 112: ateapi.Control.ListWorkers:input_type -> ateapi.ListWorkersRequest
	70,  // 113: ateapi.Control.GetWorker:input_type -> ateapi.GetWorkerRequest
	71,  // 114: ateapi.Control.CreateWorker:input_type -> ateapi.CreateWorkerRequest
	72,  // 115: ateapi.Control.UpdateWorker:input_type -> ateapi.UpdateWorkerRequest
	73,  // 116: ateapi.Control.DeleteWorker:input_type -> ateapi.DeleteWorkerRequest
	74,  // 117: ateapi.Control.DrainWorker:input_type -> ateapi.DrainWorkerRequest
	75,  // 118: ateapi.Control.ListActors:input_type -> ateapi.ListActorsRequest
	40,  // 119: ateapi.Control.CreateAtespace:input_type -> ateapi.CreateAtespaceRequest
	41,  // 120: ateapi.Control.GetAtespace:input_type -> ateapi.GetAtespaceRequest
	42,  // 121: ateapi.Control.ListAtespaces:input_type -> ateapi.ListAtespacesRequest
	44,  // 122: ateapi.Control.DeleteAtespace:input_type -> ateapi.DeleteAtespaceRequest
	45,  // 123: ateapi.Control.CreateActorTemplate:input_type -> ateapi.CreateActorTemplateRequest
	46,  // 124: ateapi.Control.GetActorTemplate:input_type -> ateapi.GetActorTemplateRequest
	47,  // 125: ateapi.Control.ListActorTemplates:input_type -> ateapi.ListActorTemplatesRequest
	49,  // 126: ateapi.Control.DeleteActorTemplate:input_type -> ateapi.DeleteActorTemplateRequest
	82,  // 127: ateapi.Debug.DebugClear:input_type -> ateapi.DebugClearRequest
	84,  // 128: ateapi.ActorIdentity.MintJWT:input_type -> ateapi.MintJWTRequest
	86,  // 129: ateapi.ActorIdentity.MintCert:input_type -> ateapi.MintCertRequest
	12,  // 130: ateapi.Control.GetActor:output_type -> ateapi.Actor
	12,  // 131: ateapi.Control.CreateActor:output_type -> ateapi.Actor
	12,  // 132: ateapi.Control.UpdateActor:output_type -> ateapi.Actor
	54,  // 133: ateapi.Control.SuspendActor:output_type -> ateapi.SuspendActorResponse
	56,  // 134: ateapi.Control.PauseActor:output_type -> ateapi.PauseActorResponse
	58,  // 135: ateapi.Control.ResumeActor:output_type -> ateapi.ResumeActorResponse
	12,  // 136: ateapi.Control.DeleteActor:output_type -> ateapi.Actor
	16,  // 137: ateapi.Control.GetActorSnapshot:output_type -> ateapi.ActorSnapshot
	18,  // 138: ateapi.Control.GetActorSnapshotTag:output_type -> ateapi.ActorSnapshotTag
	63,  // 139: ateapi.Control.ListActorSnapshots:output_type -> ateapi.ListActorSnapshotsResponse
	18,  // 140: ateapi.Control.CreateActorSnapshotTag:output_type -> ateapi.ActorSnapshotTag
	18,  // 141: ateapi.Control.UpdateActorSnapshotTag:output_type -> ateapi.ActorSnapshotTag
	18,  // 142: ateapi.Control.DeleteActorSnapshotTag:output_type -> ateapi.ActorSnapshotTag
	69,  // 143: ateapi.Control.ListWorkers:output_type -> ateapi.ListWorkersResponse
	77,  // 144: ateapi.Control.GetWorker:output_type -> ateapi.Worker
	77,  // 145: ateapi.Control.CreateWorker:output_type -> ateapi.Worker
	77,  // 146: ateapi.Control.UpdateWorker:output_type -> ateapi.Worker
	77,  // 147: ateapi.Control.DeleteWorker:output_type -> ateapi.Worker
	77,  // 148: ateapi.Control.DrainWorker:output_type -> ateapi.Worker
	76,  // 149: ateapi.Control.ListActors:output_type -> ateapi.ListActorsResponse
	19,  // 150: ateapi.Control.CreateAtespace:output_type -> ateapi.Atespace
	19,  // 151: ateapi.Control.GetAtespace:output_type -> ateapi.Atespace
	43,  // 152: ateapi.Control.ListAtespaces:output_type -> ateapi.ListAtespacesResponse
	19,  // 153: ateapi.Control.DeleteAtespace:output_type -> ateapi.Atespace
	21,  // 154: ateapi.Control.CreateActorTemplate:output_type -> ateapi.ActorTemplate
	21,  // 155: ateapi.Control.GetActorTemplate:output_type -> ateapi.ActorTemplate
	48,  // 156: ateapi.Control.ListActorTemplates:output_type -> ateapi.ListActorTemplatesResponse
	21,  // 157: ateapi.Control.DeleteActorTemplate:output_type -> ateapi.ActorTemplate
	83,  // 158: ateapi.Debug.DebugClear:output_type -> ateapi.DebugClearResponse
	85,  // 159: ateapi.ActorIdentity.MintJWT:output_type -> ateapi.MintJWTResponse
	87,  // 160: ateapi.ActorIdentity.MintCert:output_type -> ateapi.MintCertResponse
