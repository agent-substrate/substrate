...
| `ate-snapshot-dashboard.json` | Substrate snapshot image size and checkpoint rate ("Substrate Snapshot Size & Checkpoint Rate"), by image kind, plus checkpoint throughput. |
