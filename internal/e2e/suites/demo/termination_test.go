...
func TestGracefulWorkerTermination(t *testing.T) {
	...
	// Verify the actor lands in STATE_CRASHED.
	waitForActorStatus(ctx, t, clients, actorID, ateapipb.ActorState_ACTOR_STATE_CRASHED)
...
func TestGracefulWorkerTerminationTimeout(t *testing.T) {
	...
	// Verify the actor lands in STATE_CRASHED.
	waitForActorStatusWithTimeout(ctx, t, clients, actorID, ateapipb.ActorState_ACTOR_STATE_CRASHED, 120*time.Second)
...
func TestGracefulWorkerTerminationSuspend(t *testing.T) {
	...
	// Verify the actor lands in STATE_SUSPENDED
