...
func (x *RunRequest) GetEgressPepAddress() string {
	if x != nil {
...
type RestoreRequest struct {
	...
	Scope            SnapshotScope `protobuf:"varint,10,opt,name=scope,proto3,enum=atelet.SnapshotScope" json:"scope,omitempty"`
	EgressPepAddress string        `protobuf:"bytes,11,opt,name=egress_pep_address,json=egressPepAddress,proto3" json:"egress_pep_address,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *RestoreRequest) GetEgressPepAddress() string {
	if x != nil {
		return x.EgressPepAddress
	}
	return ""
