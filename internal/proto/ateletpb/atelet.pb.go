...
// ActorIdentityTokenDataSource writes an already-minted actor identity JWT
// to a file at the given path, relative to the root of the enclosing
// system-info volume. ateapi mints the token (audience- and TTL-bound, per
// the template) when it builds the spec; atelet only writes the bytes.
...
func (x *ActorIdentityTokenDataSource) Reset() {
	*x = ActorIdentityTokenDataSource{}
	mi := &file_atelet_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ActorIdentityTokenDataSource) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ActorIdentityTokenDataSource) ProtoMessage() {}

func (x *ActorIdentityTokenDataSource) ProtoReflect() protoreflect.Message {
	mi := &file_atelet_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ActorIdentityTokenDataSource.ProtoReflect.Descriptor instead.
func (*ActorIdentityTokenDataSource) Descriptor() ([]byte, []int) {
	return file_atelet_proto_rawDescGZIP(), []int{16}
}

func (x *ActorIdentityTokenDataSource) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
func (x *ActorIdentityTokenDataSource) GetToken() []byte {
	if x != nil {
		return x.Token
	}
	return nil
...
type SystemInfoDataSource struct {
	...
	//	*SystemInfoDataSource_ActorIdentityToken
...
func (x *SystemInfoDataSource) GetActorIdentityToken() *ActorIdentityTokenDataSource {
	if x != nil {
		if x, ok := x.DataSource.(*SystemInfoDataSource_ActorIdentityToken); ok {
			return x.ActorIdentityToken
		}
	}
	return nil
}
...
type SystemInfoDataSource_ActorIdentityToken struct {
	ActorIdentityToken *ActorIdentityTokenDataSource `protobuf:"bytes,3,opt,name=actor_identity_token,json=actorIdentityToken,proto3,oneof"`
}
...
func (*SystemInfoDataSource_ActorIdentityToken) isSystemInfoDataSource_DataSource() {}
...
var file_atelet_proto_goTypes = []any{
	...
	(*ActorIdentityTokenDataSource)(nil),    // 19: atelet.ActorIdentityTokenDataSource
...
var file_atelet_proto_depIdxs = []int32{
	...
	24, // 6: atelet.WorkloadSpec.containers:type_name -> atelet.Container
	22, // 7: atelet.WorkloadSpec.volumes:type_name -> atelet.Volume
	...
	19, // 13: atelet.SystemInfoDataSource.actor_identity_token:type_name -> atelet.ActorIdentityTokenDataSource
	...
	32, // 34: atelet.RestoreRequest.local_config:type_name -> atelet.LocalCheckpointConfiguration
	33, // 35: atelet.RestoreRequest.external_config:type_name -> atelet.ExternalCheckpointConfiguration
	...
	34, // 42: atelet.AteomHerder.Checkpoint:input_type -> atelet.CheckpointRequest
	38, // 43: atelet.AteomHerder.Restore:input_type -> atelet.RestoreRequest
	36, // 44: atelet.AteomHerder.UploadPausedCheckpoint:input_type -> atelet.UploadPausedCheckpointRequest
	...
	31, // 47: atelet.AteomHerder.Run:output_type -> atelet.RunResponse
	35, // 48: atelet.AteomHerder.Checkpoint:output_type -> atelet.CheckpointResponse
	39, // 49: atelet.AteomHerder.Restore:output_type -> atelet.RestoreResponse
	37, // 50: atelet.AteomHerder.UploadPausedCheckpoint:output_type -> atelet.UploadPausedCheckpointResponse
...
func file_atelet_proto_init() {
	...
	file_atelet_proto_msgTypes[17].OneofWrappers = []any{
		...
		(*SystemInfoDataSource_ActorIdentityToken)(nil),
	}
