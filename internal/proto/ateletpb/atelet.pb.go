...
type RestoreRequest struct {
	...
	SnapshotKind  string `protobuf:"bytes,12,opt,name=snapshot_kind,json=snapshotKind,proto3" json:"snapshot_kind,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_atelet_proto_rawDesc = "" +
	...
	"\rsnapshot_kind\x18\f \x01(\tR\fsnapshotKindB\b\n" +
	"\x06config\"\x11\n" +
