...
type VolumePluginControlPlane interface {
	...
	CreateVolume(ctx context.Context, name string, capacity string, driverName string, parameters map[string]string, mode ateapipb.VolumeAccessMode) (volumeID string, volumeContext map[string]string, err error)
...
type VolumePluginWorkerPlane interface {
	MountVolume(ctx context.Context, volumeID string, targetPath string, volumeContext map[string]string, publishContext map[string]string, mode ateapipb.VolumeAccessMode) error
