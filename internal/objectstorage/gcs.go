...
// NewGCSClient wraps a *storage.Client to implement the ObjectStorage interface.
...
// FetchFromGCS downloads the content of an object via its gs:// URL.
...
// FetchLocalFileFromGCS downloads an object and writes it to a local file.
...
// SendToGCSWithZstd compresses content with zstd and uploads it.
...
// SendLocalFileToGCSWithZstd reads a local file, compresses it with zstd, and uploads it.
...
// FetchLocalFileFromGCSWithZstd downloads a zstd-compressed object and writes
// the decompressed content to a local file.
