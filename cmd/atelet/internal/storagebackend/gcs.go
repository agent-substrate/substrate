...
func NewGCSClient(client *storage.Client) objectstorage.Store {
	return &gcsClient{client: client}
}

// SupportsStreamingWrites marks that the GCS client's PutObject
...
// does not implement this capability.)
func (g *gcsClient) SupportsStreamingWrites() {}
