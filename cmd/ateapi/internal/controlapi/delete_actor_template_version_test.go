...
func TestValidateDeleteActorTemplateVersionRequest(t *testing.T) {
	tests := []struct {
		...
		field.ErrorList{field.Required(field.NewPath("actor_template_version", "atespace"), "")},
	}, {
		"missing name",
		&ateapipb.DeleteActorTemplateVersionRequest{ActorTemplateVersion: &ateapipb.ObjectRef{Atespace: "ns1"}},
