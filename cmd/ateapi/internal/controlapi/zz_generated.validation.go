...
func Validate_ExternalVolume(
	...
	{ // field ateapipb.ExternalVolume.PublishContext
		fn := func(
			fldPath *field.Path,
			obj, oldObj map[string]string,
			oldValueCorrelated bool) (errs field.ErrorList) {
			...
			if e := validate.EachMapVal(ctx, op, fldPath, obj, oldObj, validate.DirectEqual,
				func(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *string) field.ErrorList {
					return validate.MaxLength(ctx, op, fldPath, obj, oldObj, 1024)
				}); len(e) != 0 {
				errs = append(errs, e...)
			}
			return
	...
	{ // field ateapipb.ExternalVolume.PublishContextNode
		fn := func(
			fldPath *field.Path,
			obj, oldObj *string,
			oldValueCorrelated bool) (errs field.ErrorList) {
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.ExternalVolume) *string {
				return &oldObj.PublishContextNode
			})
	...
	{ // field ateapipb.ExternalVolume.AccessMode
		fn := func(
			...
			if e := validate.UpdateValue(ctx, op, fldPath, obj, oldObj,
				func(a ateapipb.VolumeAccessMode, b ateapipb.VolumeAccessMode) bool { return a == b }, validate.NoModify).MarkShortCircuit(); len(e) != 0 {
				errs = append(errs, e...)
				earlyReturn = true
			}
			if earlyReturn {
