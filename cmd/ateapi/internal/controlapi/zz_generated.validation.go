...
func Validate_ActorStatus(
	...
	{ // field ateapipb.ActorStatus.ActorVolumes
		fn := func(
			...
			// iterate the list and call the type's validation function
			if e := validate.EachPtrSliceVal(ctx, op, fldPath, obj, oldObj, nil, nil, Validate_ExternalVolume); len(e) != 0 {
				errs = append(errs, e...)
			}
			return
		}
...
func Validate_DeleteActorRequest(
	...
	// field ateapipb.DeleteActorRequest.AnyState has no validation
	return errs
}
...
func Validate_ResumeActorRequest(
	...
	// field ateapipb.ResumeActorRequest.Boot has no validation
	return errs
}
