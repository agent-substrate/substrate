...
func TestValidateResourceMetadataCreate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			assertValidateErr(t, Validate_ResourceMetadata(context.Background(), op, nil, tt.obj, nil), tt.want)
		})
	}
}
...
func TestValidateResourceMetadataUpdate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			assertValidateErr(t, Validate_ResourceMetadata(context.Background(), op, nil, tt.newObj, tt.oldObj), tt.want)
		})
	}
}
...
func TestValidateResourceMetadataNameAndAtespaceFormat(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			op := operation.Operation{Type: operation.Create}
			assertValidateErr(t, Validate_ResourceMetadata(context.Background(), op, nil, obj, nil), tt.want)
		})
	}
}
...
func TestValidateObjectRef(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			op := operation.Operation{Type: operation.Create}
			assertValidateErr(t, Validate_ObjectRef(context.Background(), op, nil, tt.ref, nil), tt.want)
		})
	}
}
