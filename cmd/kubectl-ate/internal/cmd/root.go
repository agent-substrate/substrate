...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&tokenFile, "token-file", "", "Path to a bearer token for ate-api authentication. Defaults to a Kubernetes ServiceAccount token.")
