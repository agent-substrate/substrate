...
| Configuration | env vars (`ATE_INSTALL_KIND`, `ATE_DATAPLANE`, `KUBECTL_CONTEXT`, …) | flags, with the env vars still honored as defaults |
...
Invalid input now fails before any cluster mutation. `--dataplane=nginx`
