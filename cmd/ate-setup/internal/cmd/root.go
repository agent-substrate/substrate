...
func init() {
	...
	f.StringVar(&opts.CredentialProviderName, "credential-provider-name", "", "Credential provider the injector serves, as a substrate-secret:// class prefix (default substrate-secret://kubernetes.io)")
