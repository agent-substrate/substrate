...
func init() {
	...
	f.StringVar(&opts.CredentialProviderName, "credential-provider-name", "", "Credential provider the injector serves, as a substrate-secret:// prefix (default substrate-secret://kubernetes.io)")
