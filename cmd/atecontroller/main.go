...
func main() {
	...
	workerPoolLister := workerPoolInformer.Lister()
	...
	workersync.NewWorkerPoolSyncer(ateapiClient, workerPodInformer, workerPoolLister, workerPoolInformer.Informer()).Start(runCtx)
