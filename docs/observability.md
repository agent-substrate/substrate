...
| `ate.actor.crashes` | ateapi | counter | Number of times actors transitioned to `STATUS_CRASHED` (labels `ate.operation.name`, `ate.failure.reason`, `ate.template.namespace`, `ate.template.name`, `ate.workerpool.name`, `ate.sandbox.class`) |
