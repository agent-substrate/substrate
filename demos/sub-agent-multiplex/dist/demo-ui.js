...
// demos/sub-agent-multiplex/node_modules/hono/dist/compose.js
...
// demos/sub-agent-multiplex/node_modules/hono/dist/request/constants.js
var GET_MATCH_RESULT = /* @__PURE__ */ Symbol();

// demos/sub-agent-multiplex/node_modules/hono/dist/utils/body.js
...
// demos/sub-agent-multiplex/node_modules/hono/dist/utils/url.js
var splitPath = (path) => {
...
// demos/sub-agent-multiplex/node_modules/hono/dist/request.js
...
// demos/sub-agent-multiplex/node_modules/hono/dist/utils/html.js
...
// demos/sub-agent-multiplex/node_modules/hono/dist/context.js
...
// demos/sub-agent-multiplex/node_modules/hono/dist/router.js
...
// demos/sub-agent-multiplex/node_modules/hono/dist/utils/constants.js
var COMPOSED_HANDLER = "__COMPOSED_HANDLER";

// demos/sub-agent-multiplex/node_modules/hono/dist/hono-base.js
...
// demos/sub-agent-multiplex/node_modules/hono/dist/router/reg-exp-router/matcher.js
var emptyParam = [];
...
// demos/sub-agent-multiplex/node_modules/hono/dist/router/reg-exp-router/node.js
...
// demos/sub-agent-multiplex/node_modules/hono/dist/router/reg-exp-router/trie.js
var Trie = class {
  #context = { varIndex: 0 };
  #root = new Node();
...
// demos/sub-agent-multiplex/node_modules/hono/dist/router/reg-exp-router/router.js
...
// demos/sub-agent-multiplex/node_modules/hono/dist/router/smart-router/router.js
...
// demos/sub-agent-multiplex/node_modules/hono/dist/router/trie-router/node.js
...
// demos/sub-agent-multiplex/node_modules/hono/dist/router/trie-router/router.js
...
// demos/sub-agent-multiplex/node_modules/hono/dist/hono.js
...
// demos/sub-agent-multiplex/node_modules/@hono/node-server/dist/index.mjs
...
// demos/sub-agent-multiplex/ui/demo-ui.ts
var import_node_child_process = require("node:child_process");
var app = new Hono2();
var NS = process.env.DEMO_NAMESPACE || "sub-agent";
var ATE_ENDPOINT = process.env.ATE_ENDPOINT || "api.ate-system.svc.cluster.local:443";
var BROKER_URL = "http://nano-broker.sub-agent.svc.cluster.local:8091";
var clusterState = { pods: [], actors: [] };
var brokerData = { connectionStatus: "closed", pairingCode: null, registeredAgents: [], logs: [], assignments: [], audits: [] };
var stats = {
...
var VALID_ACTOR_IDS = new Set(Object.values(AGENT_META).map((m) => m.id));
var runCmd = (cmd) => {
...
var fetchWithTimeout = async (url, timeout = 3e3) => {
...
async function syncState() {
  try {
    ...
    if (brokerOut) {
      ...
      const completed = brokerOut.assignments?.filter((a) => a.state === "completed" && a.completed_at) || [];
    ...
    if (actorsOut && actorsOut.trim().startsWith("{")) {
      try {
        ...
        actors = allActors.filter((a) => VALID_ACTOR_IDS.has(a.actorId || a.actor_id));
        clusterState.actors = actors.map((a) => ({
        ...
        console.error("Actors JSON Parse Error");
      }
    }
    if (podsOut && podsOut.trim().startsWith("{")) {
      try {
        ...
        clusterState.pods = podsRaw.map((p) => {
          const activeActor = actors.find((a) => (a.ateomPodName || "").split("/").pop() === p.metadata.name);
        ...
        console.error("Pods JSON Parse Error");
      }
    }
    const now = Date.now();
    const elapsed = (now - stats.lastSync) / 1e3;
    stats.lastSync = now;
    const runningActors = actors.filter((a) => a.status === "STATUS_RUNNING").length;
...
app.get("/api/stats", (c) => {
  ...
  const safeDensity = Math.max(1, density).toFixed(2);
