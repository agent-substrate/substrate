...
# into another namespace means installing with a deployment that renders them,
# and using this script only for the bootstrap steps; require_default_namespace_for_manifests
